...
#SBATCH --output=lewm_latent_train_%j.out
#SBATCH --error=lewm_latent_train_%j.err
...
echo "=== Snellius latent planner training started ==="
echo "node=$(hostname)"
echo "repo=${REPO_DIR}"
...
srun --unbuffered python train_latent_planner.py \
